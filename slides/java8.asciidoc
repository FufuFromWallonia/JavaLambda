...
== Method/Constructor reference 1/2
...
include::../code/src/main/java/java8/methodref/MethodReferenceExample.java[tag=comparatorLambda]
----
L'expression lambda prend 2 String en paramètres et les applique sur une méthode.
On peut donc la  remplacer par une référence de méthode.

== Method/Constructor reference 2/2

.Comparator avec une expression lambda et une référence de méthode
[source,java,indent=0]
----
